 ...
 * a JScrollPane.
 */
public class Componentes extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
	/**
	 * 
	 */
	 ...
	 */
	public Componentes(JTextComponent component) {
		this(component, 3);
	}
	 ...
	 */
	public Componentes(JTextComponent component, int minimumDisplayDigits) {
